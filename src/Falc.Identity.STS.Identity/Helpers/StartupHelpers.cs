...
using Falc.Identity.STS.Identity.Configuration.ApplicationParts;
using Falc.Identity.STS.Identity.Configuration.Constants;
using Falc.Identity.STS.Identity.Configuration.Interfaces;
using Falc.Identity.STS.Identity.Helpers.Localization;
using Falc.Identity.STS.Identity.Services;

namespace Falc.Identity.STS.Identity.Helpers
{
